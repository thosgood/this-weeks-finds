...
MDS="./markdown/251-300/*.md"
TEX="./latex/TWF_251-300.tex"
...
printf "\n" >> $TEX
printf '%s\n' "\title{This Week's Finds in Mathematical Physics (251--300)}" >> $TEX
...
printf '%s\n' '  \\[1em]{\huge\textit{Weeks 251 to 300}}' >> $TEX
printf '%s\n' '  \\[4em]{\LARGE \textit{May 5, 2007} to \textit{August 11, 2010}}' >> $TEX
