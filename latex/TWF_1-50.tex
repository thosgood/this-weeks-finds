...
\item
  ...
  \href{https://arxiv.org/abs/gr-qc/9301017}{\texttt{gr-qc/9301017}}, in
  tex.
\end{enumerate}
...
--- one gets the group \(\mathrm{Sp}(n)\) and Lie algebra
\(\mathfrak{sp}(n)\). To be precise, \(\mathrm{SO}(n)\) consists of all
\(n\times n\) orthogonal real matrices with determinant \(1\),
...
\item
  ...
  \href{https://arxiv.org/abs/gr-qc/9302020}{\texttt{gr-qc/9302020}}, 15
  pages.
\end{enumerate}
...
\href{https://arxiv.org/abs/hep-th/9301062}{\texttt{hep-th/9301062}} in
latex. (Week 2)
\end{quote}
...
``We are not stuck with gluing'', by David Yetter and Louis Crane,
preprint available as
\href{https://arxiv.org/abs/hep-th/9302118}{\texttt{hep-th/9302118}} in
...
\item
  ...
  available as
  \href{https://arxiv.org/abs/gr-qc/9409004}{\texttt{gr-qc/9409004}}, or
  from WWW by \texttt{http://vishnu.nirvana.phys.psu.edu/}
\end{enumerate}
...
\item
  ...
  LaTeX format available as
  \href{https://arxiv.org/abs/gr-qc/9411007}{\texttt{gr-qc/9411007}} (or
  as ``\texttt{spin.tex}'' by ftp as described at the end of this
  article).
\end{enumerate}
