...
actually be the SAME THING in two different disguises. You heard it here
first, folks!
...
paper ``Quantum Gravity and the Algebra of Tangles''. I hope to make
these a lot clearer as time goes by.
...
\tightlist
\item
  ``\(2\)-categories and 2-knots'', by John Fischer, preprint, last
  revised Feb.~6 1993. (Fischer is at
  \texttt{fischer-john@math.yale.edu})
\end{enumerate}
...
\setcounter{enumi}{2}
\item
  \emph{Formal Category Theory: Adjointness for \(2\)-categories}, by
  John W. Gray, Lecture Notes in Mathematics \textbf{391},
...
to those mentioned above, but the resulting TQFT in \(4\)-dimensions did
not by itself yield interesting new invariants of 4-manifolds. The
procedure Yetter describes here generalizes the earlier work by allowing
the inclusion of an embedded 2-manifold.
...
in 1997 under the title ``The Life of the Cosmos'' --- see
...
even a mathematician can understand in my paper ``\texttt{string.tex}'',
available by ftp along with all my \protect\hyperlink{week}{``Week''}
...
Unfortunately, there are SEVERAL DIFFERENT WAYS to set up
...
quantum gravity and BF theory in 4 dimensions, Chern-Simons theory in 3
dimensions, and the \(G/G\) gauged WZW model in 2 dimensions. We also
describe the relation between link (or multiloop) invariants and
...
\tightlist
\item
  ``On the definition of \(2\)-category of 2-knots'', by V. M. Kharlamov
  and V. G. Turaev, preprint.
\end{enumerate}
