...
complex plane and sticking on one more point, "∞" \-- think of a
sphere with "∞" as the north pole. If we have a Riemann surface, we
...
6) Braids, Links, and Mapping Class Groups, by Joan S. Birman, Annals
of Mathematics Studies no. 82, Princeton University Press, 1974.
...
string, seems largely unexplored, but see "[week18](week18.html)".)
...
touched upon in "[week13](week13.html)". I should also add that
"[week13](week13.html)" indicates, at least in the g = 1 case, why
...
7) Universal constructions in Teichmueller theory, by R. C. Penner,
Adv. Math. 98 (1993), 143-215.
...
"[week16](week16.html)" for an explanation) and the "pentagon
