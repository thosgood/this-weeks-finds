...
Now say you start at the origin in this squashed version of $\mathbb{R}^n$ and
...
To get up to $\mathrm{E}_7$ and $\mathrm{E}_8$, we need to take a different viewpoint, which
