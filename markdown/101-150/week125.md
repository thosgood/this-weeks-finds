...
First I need to talk a bit about lattices and \mathrm{SL}(2,Z). As I explained in
...
Associated to the hexagonal lattice is a special element of \mathrm{SL}(2,Z) that
...
Right away this implies that \mathrm{SL}(2,Z) has a certain inherent "12-ness"
to it. Let me explain. \mathrm{SL}(2,Z) is a nonabelian group - this is how
...
matrix in \mathrm{SL}(2,Z), getting a new basis
...
space H/\mathrm{SL}(2,Z), where \mathrm{SL}(2,Z) acts on H as above!

Now, the quotient space H/\mathrm{SL}(2,Z) is not a smooth manifold, because
while the upper halfplane H is a manifold and the group \mathrm{SL}(2,Z) is
discrete, the action of \mathrm{SL}(2,Z) on H is not free: i.e., certain points
in H don't move when you hit them with certain elements of \mathrm{SL}(2,Z).
...
So we expect that H/\mathrm{SL}(2,Z) has singularities corresponding to points in
...
replace the group \mathrm{SL}(2,Z) by

                            \mathrm{PSL}(2,Z) = \mathrm{SL}(2,Z)/{±1}

Since -1 doesn't move *any* points of H, the action of \mathrm{SL}(2,Z) on H
gives an action of \mathrm{PSL}(2,Z), and the moduli space of elliptic curves is
H/\mathrm{PSL}(2,Z).

Now most points in H aren't preserved by any element of \mathrm{PSL}(2,Z).
...
domain" for the action of \mathrm{PSL}(2,Z) on H. In other words, every elliptic
...
quotient of the smooth manifold H by the discrete group \mathrm{SL}(2,Z), and its
...
Well, it turns out that you can get any \mathrm{SL}(2,Z)-equivariant line bundle
on H, up to isomorphism, by taking the trivial line bundle on H and
using a 1-dimensional representation of \mathrm{SL}(2,Z) to say how it acts on
the fiber. So we just need to understand 1-dimensional representations
of \mathrm{SL}(2,Z). The set of isomorphism classes of these forms a group under
tensor product, and this is the group we're after.

Well, a 1-dimensional representation of a group always factors through
the abelianization of that group. We saw the abelianization of \mathrm{SL}(2,Z)
