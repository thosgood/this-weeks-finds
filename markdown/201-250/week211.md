...
period 8: C~n+8~ consists of 16 x 16 matrices whose entries lie in C_n!
...
size to get C_n to have dimension 2^n. So, when I write "R + R" next
...
representation of C_n, it gives us a representation of C~n-1~. Ditto
for maps between representations. So, we get a functor from the category
of representations of C_n to the category of representations of C~n-1~.
