...
in any function f, and out pops the identity function x \|→ x.
...
→ 0. More importantly, in set theory, A^B^ stands for the set of
...
sets. Here the product A × B of two sets A and B is their usual
