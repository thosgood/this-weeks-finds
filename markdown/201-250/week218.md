...
defined in \"[week199](week199.html)\". Ignoring a certain little
...
We can also also take the limit as n → ∞. If we do this to the integers
...
with the related table in \"[week205](week205.html)\":
...
As explained near the end of \"[week216](week216.html)\", we can define
a kind of zeta function for a Z-set as follows:

Z(x) = exp(∑~n\>0~ \|fix(f^ n^)\| x^n^ / n)
...
\"[week217](week217.html)\", formal power series live in the monoid
algebra of (N,+,0), while Dirichlet series live in the monoid algebra of
(N,×,1). (N,+,0) is the free commutative monoid on one generator, while
(N,×,1) is the free commutative monoid on countably many generators -
...
I explained this in \"[week185](week185.html)\",
\"[week190](week190.html)\", and \"[week202](week202.html)\". I\'ve even
...
> measure of a+p^n^Z~p~ to be p^-n^. Then this is finitely additive,
...
In \"[week201](week201.html)\" I described the Galois group
...
> Gal(K^-^/K) is isomorphic to K\*\\Adeles~K~\*/(K~∞~\*)^0^.
>
...
> example, I can just write down a big subgroup e.g. K~∞~\* times the
...
>
>      function z → exp(2πiz)        Weierstrass ℘-function 
>                                    (and its derivative)
>
