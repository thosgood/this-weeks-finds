...
20) Mark Weber, "Operads within monoidal pseudo algebras", available as [`math.CT/0410230`](http://www.arXiv.org/abs/math.CT/0410230).
...
> particular monoidal bicategory $\mathsf{Alg}(R\mbox{-}\mathsf{Mod})$ based on a commutative ring
...
> $\mathsf{Alg}(R\mbox{-}\mathsf{Mod})$ as a fundamental example. (It is discussed much later in
> the last part of
>
...
>
> I pointed out to Jack that this was the nerve of $\mathsf{Alg}(R\mbox{-}\mathsf{Mod})$ and he
