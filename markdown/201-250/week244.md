...
in \"[week70](week70.html)\" - and in more detail in items J and K of
\"[week117](week117.html)\", back when I was giving a minicourse on
...
projective space\", or RP^∞^ for short. This is built from one vertex,
...
E in \"[week230](week230.html)\", where I sketch how these quiver
...
(This might seem like a roundabout way to get to n × n matrices, but
...
This is called ζ, or the \"zeta function\" of our category. Sometimes ζ
...
categories. And when ζ ^-1^ = μ exists, it\'s really easy to define his
...
space of states, where a morphism f: x → y acts on x to give y, and it
...
vector space of states, where f: x → y acts on y to give x, and it acts
...
If ζ has an inverse, our category has both a weighting and a
coweighting, since we can solve both these equations to find w and w\*.
But often there will be a weighting and coweighting even when ζ doesn\'t
