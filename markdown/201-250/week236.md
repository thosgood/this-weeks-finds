...
Believe it or not, this goes to zero after about 7 × 10^121210694^
...
Well, this is a matter of taste, but you might be interested in ε~1~.
...
Anyway, the next really interesting ordinal I know after ε~1~ is ε~2~.
...
ε~1~ + 1, ω^ε~1~\ +\ 1^, ω^ω^ε~1~\ +\ 1^^, ω^ω^ω^ε~1~\ +\ 1^^^,\...
...
where each term is less than or equal to the previous one, and each α~i~
is not a fixed point of φ~γ~i~~
...
\"[week227](week227.html)\", and this book mentioned in
\"[week70](week70.html)\" - now you can get it free online:
...
\"[week164](week164.html)\" and \"[week230](week230.html)\" if you\'re
...
\"[week63](week63.html)\". It\'s conjectured that the Greeks got
...
Oxyrhynchus (see \"[week221](week221.html)\"), and a couple more in the
...
As I explained in \"[week185](week185.html)\", many basic facts about
...
of \"structure types\" or \"species\" - see \"[week202](week202.html)\"
...
>
> I realized after I posted \"[week236](week236.html)\" that some people
...
> 4, 26, 41, 60, 83, 109, 139, 173, 211, 253, 299, 348, \...
>
> and apparently it takes about 3 × 10^60605351^ steps to reach zero!
...
increase for approximately 2.6 × 10^60605351^ steps\", whatever that
means.
...
4th Goodstein sequence a~i~, where we count things so that
