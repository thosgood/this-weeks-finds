...
chance that you\'re both right is 1/2 × 1/2 = 1/4.
...
\"[week106](week106.html)\" and \"[week145](week145.html)\", and
\"[week178](week178.html)\". If you read these, you\'ll know that points
...
projective geometry: it\'s the group G = PGL(3), consisting of 3×3
...
of it as a subset S of X × Y: we say a pair (x,y) is in S if the
relation holds.

Next, suppose some group G acts on both X and Y. What\'s an
\"invariant\" relation? It\'s a subset S of X × Y such that whenever
...
G on X and Y, hence on X × Y - and in a minute we\'re gonna need all the
sides we can get!
...
element of G. So, it\'s a subset of X × Y that\'s invariant under the
...
Now, in \"[week249](week249.html)\" I explained how you could form the
...
If you remember everything in \"[week249](week249.html)\" - and I bet
...
together. This improves the chance of winning from 1/2 × 1/2 (the
