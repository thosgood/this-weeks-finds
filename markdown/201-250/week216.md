...
the Riemann ζ function can vanish is in the strip where
...
ζ(s) = 1/(1 - 2^-s^) 1/(1 - 3^-2s^) 1/(1 - 5^-s^) 1/(1 - 5^-s^) \...
...
And, the ζ function records the details of how this works!

For more on this covering space philosophy see
\"[week205](week205.html)\" and \"[week213](week213.html)\". This
...
\"[week215](week215.html)\" for more on this. The reason is that some of
...
we can think of it as the ring of functions on some space. The ζ
...
traditional alternative, see \"[week205](week205.html)\".)
...
system f: X → X in terms of the number of fixed points of f^ n^. When f
...
Audrey Terras has a lot of nice slide presentations about the ζ
...
*poles* of the ζ function in the critical strip
...
Finally, I should explain some more technical stuff about ζ functions
