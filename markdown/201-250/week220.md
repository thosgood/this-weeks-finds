...
this: see \"[week198](week198.html)\" for more details. So, there\'s
...
lurking in \"infinite loop spaces\". In \"[week149](week149.html)\" I
...
as k goes to ∞ and form the \"little ∞-cubes operad\". Any infinite loop
...
> procedure for turning weak ∞-groupoids (i.e. spaces) into stable
> strict ∞-groupoids (i.e. chain complexes) - followed by taking the
