...
I discussed Klein\'s quartic curve in \"[week214](week214.html)\" and
\"[week215](week215.html)\". The idea is to take the nontrivial complex
solutions of
...
lives in 11 dimensions. Back in \"[week158](week158.html)\" and
\"[week159](week159.html)\" I took a stab at understanding this. Now
...
Back in \"[week158](week158.html)\" I wrote down a Lagrangian for 11d
supergravity. This is a truly monstrous thing involving three fields:

A\) a frame field e - the \"graviton\",

B\) a field ψ taking values in the real spin-3/2 representation of the
...
\"[week104](week104.html)\". Maybe a little extra stretch could bring us
to dimension 11?
...
U(1) bundles in \"[week210](week210.html)\", so I\'ll be sort of brief
about those\....
...
\"[week158](week158.html)\", but it\'s an obvious guess after you learn
...
11d supergravity that I wrote down in \"[week158](week158.html)\".
...
the category of Lie n-algebras is equivalent to the category of L~∞~
algebras which as chain complexes have only n nonvanishing terms, the
0th to the (n-1)st. L~∞~ algebras are just algebras of Stasheff\'s L~∞~
operad in the category of chain complexes of vector spaces - see
\"[week191](week191.html)\" and especially these:
...
vector spaces\". So, a \"Lie n-superalgebra\" is an algebra of the L~∞~
...
Next, we need to specify the L~∞~ structure on this chain complex.
...
(ψ, φ, v, w) \|→ ψ\* Γ^ab^ φ v~a~ w~b~

where that \"ψ\*\" should really be \"ψ-bar\". And, magically, in 11
...
> S^1^/Z~2~ giving the E~8~ × E~8~ heterotic string.
>
> Aaron
...
>      > M-theory on S1/Z2 giving the E8 × E8 heterotic string.
>
