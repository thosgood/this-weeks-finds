...
3\) Imre Tuba and Hans Wenzl, Representations of the braid group B~3~
...
On other hand, the group SL(2,Z) consists of 2×2 integer matrices with
...
some of its charms in \"[week125](week125.html)\",
\"[week229](week229.html)\" and elsewhere.

These groups look pretty different at first. But, there\'s a
homomorphism from B~3~ onto SL(2,Z)! It goes like this:
...
The center of B~3~ is generated by the element (AB)^3^. This element
...
our homomorphism from B~3~ to SL(2,Z). So, SL(2,Z) is isomorphic to the
...
in \"[week196](week196.html)\". There\'s also a version where we use
integers mod 7, described in \"[week219](week219.html)\".)
...
\"[week229](week229.html)\", I told a nice story I heard from Michael
...
PSL(2,Z) acts on rational tangles, and there\'s a homomorphism from B~3~
...
In \"[week229](week229.html)\" I said what this shear does to a rational
...
which is a quarter turn. From \"[week229](week229.html)\" you can see
...
\"[week228](week228.html)\". With the help of this, I can show B acts
like this:
...
Let me summarize. The 3-strand braid group B~3~ acts on rational tangles
in an obvious way. The subgroup that acts trivially is precisely the
center of B~3~, generated by the full twist. Using stuff from
\"[week229](week229.html)\", it follows that the quotient of B~3~ by its
center acts on the projectivized rational homology of the torus. We thus
get a topological explanation of why B~3~ mod its center is PSL(2,Z).
...
Here SL(2,R)^\~^ is the universal cover of SL(2,R). Since π~1~(SL(2,R))
...
Monstrous Moonshine (see \"[week66](week66.html)\").
...
function only has nice transformation properties under B~3~. This is
somehow supposed to be related to how B~3~ is the \"universal central
...
3-strand braid group! I bet this moduli space is X/B~3~ for some space
...
The fact that B~3~ is a central extension of PSL(2,Z) by Z, and the
...
Among other things, he points out that the homomorphism B~3~ → SL(2,Z)
described above is the \"Burau representation\" of B~3~ evaluated at t =
1. In general, the Burau representation of B~3~ is given by:
...
\"[week261](week261.html)\" for such a proof - and much more on all this
stuff.)
...
the Eisenstein series g~2~ and g~3~. They are probably quite similar
arguments.
...
>
> g~2~(L) = 60 sum\_{z in L\'} z^-4^,
>
> and
>
> g~3~(L) = 140 sum\_{z in L\'} z^-6^,
>
> where L\'=L-{0}
>
> The modular theory asserts that:
>
> 1\. For every pain (g~2~,g~3~) there exist a lattice L such that
> g~2~(L) = g~2~ and g~3~(L) = g~3~ provided that g~2~^3^ is not equal
> to 27g~3~^2^.
>
...
The quantity g~2~^3^ - 27 g~3~^2^ is called the \"discriminant\" of the
