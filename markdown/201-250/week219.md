...
required by the molecular-kinetic theory of heat, Annalen der Physik 17
(1905), 549-560. Available at
<http://lorentz.phl.jhu.edu/AnnusMirabilis/AeReserveArticles/eins_brownian.pdf>

On the electrodynamics of moving bodies, Annalen der Physik 17 (1905),
891-921. Available at
<http://dbserv.ihep.su/~elan/src/einstein05b/eng.pdf>

Does the inertia of a body depend upon its energy content?, Annalen der
Physik 18 (1905), 639-641. Available at
...
I wrote about this gadget in \"[week214](week214.html)\" and
\"[week215](week215.html)\". Simply put, this is a \"Platonic surface\":
...
::: {align="center"}
![](pentacontihexahedron.jpg){width="200" height="200"}
![](pentacontihexahedron2.jpg){width="200" height="200"}
![](pentacontihexahedron3.jpg){width="200" height="200"}
:::
...
example is called Z/p, or F~p~ if you really want to emphasize that
you\'re thinking of it as a field.

So, let\'s do some 3d special relativity with Z/7, and see what it has
...
focus on those whose cardinality is a prime, namely the fields Z/p,
there are three possibilities: the good, the bad, and the ugly.

-   GOOD: If the field is Z/p for p = 4n+3 then -1 is negative,\
...
positivity very well. In fields like Z/p, *every* element is a sum of
positive elements.

Next, let\'s ponder the peculiarities of special relativity over a
finite field.

We can define Minkowski spacetime of any dimension over any field F:
it\'s just F^n+1^ with the quadratic form

x^2^ = x~0~^2^ - x~1~^2^ - \... - x~n~^2^
...
For any field F, 2×2 matrices with determinant 1 act as Lorentz
transformations of 3d Minkowski spacetime. I touched upon this idea when
discussing Trautman\'s \"Pythagorean spinors\" in
\"[week196](week196.html)\". Here\'s how it works:

We can think of 3d Minkowski spacetime as consisting of all 2×2 matrices
...
In this picture, the group SL(2,F) consisting of 2×2 matrices with
...
-   the hyperbolic plane H+ is the set of timelike rays in 3d Minkowski
    spacetime
-   the heavenly circle L is the set of light rays in 3d Minkowski
    spacetime
-   the hyperbolic cylinder H- is the set of spacelike rays in 3d
    Minkowski spacetime
...
This is basically by definition of \"line\". We define a \"line\" in H+
to consist of all points that are orthogonal to a given point in H-, and
...
So, H+ is a nice finite version of the hyperbolic plane with 21 points
...
\"triads\" and \"antitriads\" in H+.

Huh?

Well, for starters, a \"triad\" or \"antitriad\" is an unordered triple
of orthogonal points in H+.

Huh?

Well, remember that a point in H+ is a timelike ray in 3d Minkowski
spacetime. You can\'t have three timelike rays that are orthogonal in
ordinary special relativity, but you can over Z/7, because the sum of
...
\"buildings\" which I began to explain in \"[week186](week186.html)\".
...
geometry over Z/7 and the Fano plane. How does the Klein quartic curve
...
plane: this has got to be related to the hyperbolic plane over Z/7. So,
...
car could go straight upwards.* - Sir Fred Hoyle
