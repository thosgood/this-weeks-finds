...
::: {align="center"}
![](http://math.ucr.edu/home/baez/seven_trees_in_one_presnell_fiore.gif){width="600"}
:::
...
::: {align="center"}
![](http://math.ucr.edu/home/baez/seven_trees_in_one_presnell_bell.gif){width="600"}
:::
...
-   2-Rigs. A **2-rig** is a symmetric monoidal cocomplete category
    where the monoidal structure, which we call x, distributes over the
...
-   Distributive categories. A **distributive category** is a category
    ...
    2-rig that is not a distributive category is the category Vect, with
    direct sum and tensor product as + and x. Another example is the
...
must be risked, even in mathematics.* - Horace Lamb
