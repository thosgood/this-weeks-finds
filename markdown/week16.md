...
In "[week15](week15.html)" I talked a bit about constructing
...
define a bilinear map from A x A to A. Then the equation above says this
...
Kapranov and Voevodsky's paper (reviewed in "[week4](week4.html)"),
...
2) C. Bachas and P. M. S. Petropoulos, Comm. Math. Phys. 152 (1993)
191.
...
spins, to sum over. (See "[week5](week5.html)" for the vaguest of
...
"[week14](week14.html)". This is very readable (once you know what's
...
appears in my earlier article, "[week7](week7.html)".) I plan on going
