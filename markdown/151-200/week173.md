...
string theory in \"[week102](week102.html)\".
...
Back in \"[week145](week145.html)\", when I was trying to understand the
...
plane. Earlier, in \"[week106](week106.html)\", I explained how
...
\"[week145](week145.html)\", you can sort of see where this weird stuff
...
In \"[week83](week83.html)\" I talked about adjoint functors, and more
...
morphisms L: a → b and R: b → a, and isomorphisms i: 1~b~ =\> RL and e:
...
\"[week116](week116.html)\", and I talked about the nerve of a
1-category in part J of \"[week117](week117.html)\", so the only thing I
...
and isomorphisms L: a → b, R: b → a. In AdEquiv, there will be extra
...
> motion groups SO~3~(R) and SO~2,1~(R) (the motion group consists of
