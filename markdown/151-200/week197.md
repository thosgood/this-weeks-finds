...
\"[week149](week149.html)\" and \"[week150](week150.html)\". One reason
...
leisurely introduction see \"[week149](week149.html)\".
...
\"[week13](week13.html)\", \"[week125](week125.html)\", and
\"[week126](week126.html)\".
...
a picture of it in \"[week125](week125.html)\".
...
up when Im(z) → +∞, which means that it doesn\'t blow up when your
...
worldsheet of a string, the limit Im(z) → +∞ corresponds to the
...
\"[week125](week125.html)\", and I don\'t want to say more about it
now.)
...
-   The partition function doesn\'t change as we trace out a continuous
    ...
    Thus, the partition function defines a map
        ...
        Z: [point,tmf(n)] → {modular forms of weight n}
...
-   The kernel of the above homomorphism consists precisely of the
    torsion elements, so we get a 1-1 homomorphism
        ...
        Z: [point,tmf(n)] tensor C → {modular forms of weight n}
...
> K(ku) detects v~2~-periodic phenomena in stable homotopy theory, and
...
theory which \"detects v~2~-periodic phenomena\", and is thus \"a form\"
...
periodicity for complex K-theory is the paradigm of a \"v~1~-periodic
...
theory\". I explained what these were in \"[week149](week149.html)\",
and in \"[week150](week150.html)\" I explained how each of these things
...
on these symmetries in \"[week124](week124.html)\" and
\"[week125](week125.html)\", and showed that they\'re responsible for
...
I already vaguely explained this in \"[week125](week125.html)\".
...
rotational symmetries of the tetrahedron, also known as A~4~. This is a
12-element subgroup of SO(3). Using the fact that SO(3) has SU(2) as a
double cover, take all the points in SU(2) that map to A~4~. You get a
...
\"[week91](week91.html)\" and \"[week155](week155.html)\". So, what
...
to monstrous moonshine in \"[week66](week66.html)\", but here\'s a very
