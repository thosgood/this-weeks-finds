...
this product. We can define algebras like this using the category Vect
...
sort a \"monoid object\"- see \"[week89](week89.html)\" for more on
...
X to X tensor X, or from X to 1. This means we can\'t use commutative
...
where we *do* have maps from X to X tensor X and from X to 1. The best
...
peek at \"[week54](week54.html)\" and \"[week115](week115.html)\", where
...
that our algebra have an inner product \<x,y\>, simply demand that it
