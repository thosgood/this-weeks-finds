...
Way back in \"[week62](week62.html)\" I showed how a Dynkin diagram
...
explained in \"[week63](week63.html)\" and \"[week64](week64.html)\".
...
incidence geometries rather carefully in \"[week178](week178.html)\",
\"[week179](week179.html)\" and \"[week180](week180.html)\". But
...
\"[week162](week162.html)\". The group SL(n+1,F) acts on all these
...
\"[week180](week180.html)\". But over other fields, the set of maximal
...
\"[week184](week184.html)\", which comes from the Dynkin diagram A~n~.
...
A~2~. We\'ve seen that the Coxeter complex is a barycentrically
subdivided triangle:
...
because A~2~ is the Dynkin diagram corresponding to projective plane
...
As I explained in \"[week184](week184.html)\" and
\"[week185](week185.html)\", this relation between permutation groups
...
Let\'s calculate the q-polynomial of A~2~ using method b):
...
connection way back in \"[week62](week62.html)\". If we work over the
