...
you in \"[week183](week183.html)\" and \"[week184](week184.html)\".
...
In \"[week183](week183.html)\" I described how to q-deform the
...
elements, where q is any prime power. In \"[week184](week184.html)\" I
...
But also: if you feed your structure type a bijection f: X → Y, it spits
out a function F(f): F(X) → F(Y). This describes how we can transfer any
