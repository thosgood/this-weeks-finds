...
to be a product-preserving 2-functor F: C → Cat. And define a
...
an F: C → C\' such that F\* is a biequivalence?

As a step in this direction, Yanofsky has cooked up a model category of
algebraic 2-theories, in which F: C → C\' is a weak equivalence
