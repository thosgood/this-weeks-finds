...
C\*-algebra A into a topological space: we say x~i~ → x precisely when
...
In \"[week149](week149.html)\" I described how this sort of spectrum
gives a generalized cohomology theory, and I mentioned a bunch of
examples. I gave some more examples in \"[week150](week150.html)\" and
\"[week197](week197.html)\". But I never described the cool way to
...
lot more detail in \"[week117](week117.html)\". I also explained how you
...
category-theoretic notions can be found in \"[week121](week121.html)\".
...
K-theory groups of the integers, K~i~(Z), and the Riemann zeta function
at odd integers, ζ(2n+1). (Hmm, so maybe the different sort of spectra
...
>      xi(a) → x(a)
>
> That\'s a way of saying that the sequence x~i~ converges to x, or the
> sequence x~i~(a) converges to x(a).
>
> >      What has the index i to do with this?
>
> It\'s the index for some sequence of homomorphisms, x~i~.
>
> >      xi and x are the above mentioned homomorphisms, right?
> >
> > x is a homomorphism, x~i~ is a sequence of homomorphisms, and I\'m
> > telling you when the sequence x~i~ converges to x.
> >
...
> > > x~i~ of points in the spectrum converges to some point x. So, I
...
> > >      x: A → C
> > >
> > > And here\'s what I said: x~i~ converges to x precisely when the
> > > sequence of numbers x~i~(a) converges to the number x(a) for all a
> > > in A.
> > >
