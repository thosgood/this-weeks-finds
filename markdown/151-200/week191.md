...
\"[week185](week185.html)\" I explained how it lets us categorify the
...
feeding the outputs of n operations g~1~,..,g~n~ into the inputs of an
n-ary operation f, obtaining a new operation which we call f o
(g~1~,\...,g~n~). We demand that there be a unary operation serving as
...
\"[week119](week119.html)\".) However, the usual group laws such as
...
Recall from \"[week89](week89.html)\" that we can define a \"monoid
