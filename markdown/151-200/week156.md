...
black holes, superfluid hydrogen, T violation, the τ neutrino, and the
Higgs boson.
...
[astro-ph/9901023](http://xxx.lanl.gov/abs/astro-ph/9901023).
...
available online at
<http://www.sciencemag.org/cgi/content/abstract/289/5484/1532>
...
for helping discover P violation in the β decay of radioactive cobalt
...
experiment. In β decay, a neutron turns into a proton, an electron and
...
discovery of direct evidence for the τ neutrino. If you don\'t remember
...
generations of leptons: the electron, muon and τ and their corresponding
neutrinos. Of the leptons, the τ is the heaviest and thus hardest to
produce. Tau neutrinos are produced by the decay of τ particles, but
...
beam of a τ neutrinos and letting it collide with some stuff to form τ
particles again.
...
the Nu Tau\", where ν~τ~ is the standard abbrevation for τ neutrino.
...
good to directly observe the τ neutrino.
...
representation H must admit an antiunitary intertwiner J: H → H with
...
Poincare group is an antiunitary operator with (CPT)^2^ = -1^2j^. So
indeed we do have (CPT)^2^ = 1 in the bosonic case, making these
representations real, and (CPT)^2^ = -1 in the fermionic case, making
