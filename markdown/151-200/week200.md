...
I explained how this works in \"[week136](week136.html)\" so I won\'t do
...
Well, in \"[week89](week89.html)\" I described a \"monad\" in an
...
\"[week92](week92.html)\" so I won\'t do it again here. The upshot is
...
\"[week118](week118.html)\", and also \"[week174](week174.html)\".
...
of T-algebras is equivalent to D when the forgetful functor R: D → C is
...
reason. And, whenever we have a pair of adjoint functors R: D → C and L:
C → D, we get a monad T = LR and a functor from D to C^T^. This is just
...
\"[week92](week92.html)\", in even greater generality than we need here,
...
-   Cat^T^ = \"symmetric monoidal categories\" gives a sort of logic
    ...
    \"[week191](week191.html)\" for more. This doctrine is weaker than
