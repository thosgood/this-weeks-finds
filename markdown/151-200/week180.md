...
The Dynkin diagram of $\mathrm{Spin}(5,\mathbb{C})$ is two dots connected by a double edge:
$$
  \begin{tikzpicture}
...
But just to be clear, let's look at $\mathrm{SO}(n,\mathbb{C})$
...
geometry associated to $\mathrm{Spin}(n,\mathbb{C})$.
