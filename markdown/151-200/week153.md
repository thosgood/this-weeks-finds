...
the myriad-myriadth order, i.e. 10^8 to the 10^8th power.
...
C\[\mathbb{CP}^2,\mathbb{CP}^4,\mathbb{CP}^6,...\]
...
homomorphism from C\[\mathbb{CP}^2,\mathbb{CP}^4,\mathbb{CP}^6,...\] to the complex numbers.
...
Since the algebra C\[\mathbb{CP}^2,\mathbb{CP}^4,\mathbb{CP}^6,...\] is generated by the guys
\mathbb{CP}^2n^, all the information to describe a genus is contained in the
"logarithm"

LOG(x) = sum |\mathbb{CP}^2n^| x^2n+1^ / (2n+1)
