...
is type $II_\infty$ if it admits a trace whose value on projections is
...
There is more than one type $II_\infty factor, but again there is only one
...
hyperfinite $II_\infty$ factor is the right algebra of observables for a free
