# October 2, 1993 {#week20}

_(All the figures in Week 20 were made by Simon Burton.)_
...
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig1.pdf}$$
and then set down another triangle of cannonballs on top of the first
layer, one in every other hole, thus:
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig2.pdf}$$
and another:
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig3.pdf}$$
...
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig4.pdf}$$
...
cuboctahedron:
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig5.pdf}$$
...
view:
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig6.pdf}$$
and a bottom view:
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig7.pdf}$$
...
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig8.pdf}$$
to
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig9.pdf}$$
...
$$\includegraphics[max width=0.8\linewidth]{../images/wk20_fig5.pdf}\quad\includegraphics[max width=0.8\linewidth]{../images/wk20_fig10.pdf}$$
