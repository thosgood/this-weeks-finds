...
$$\includegraphics[max width=0.65\linewidth]{../images/wk20_fig1.pdf}$$
and then set down another triangle of cannonballs on top of the first
layer, one in every other hole, thus:
$$\includegraphics[max width=0.65\linewidth]{../images/wk20_fig2.pdf}$$
and another:
$$\includegraphics[max width=0.65\linewidth]{../images/wk20_fig3.pdf}$$
...
$$\includegraphics[max width=0.65\linewidth]{../images/wk20_fig4.pdf}$$
...
cuboctahedron:
$$\includegraphics[max width=0.65\linewidth]{../images/wk20_fig5.pdf}$$
...
view:
$$\includegraphics[max width=0.65\linewidth]{../images/wk20_fig6.pdf}$$
and a bottom view:
$$\includegraphics[max width=0.65\linewidth]{../images/wk20_fig7.pdf}$$
...
$$\includegraphics[max width=0.65\linewidth]{../images/wk20_fig5.pdf}\quad\includegraphics[max width=0.65\linewidth]{../images/wk20_fig10.pdf}$$
