...
I described this briefly in "[week17](week17.html)," before I had
...
Jones original example corresponded to the case su(2). In this case the
...
[gr-qc/9308002](http://xxx.lanl.gov/abs/gr-qc/9308002).
...
bit on this issue see "[week27](week27.html)".) Only after choosing
...
available in Revtex form as
[gr-qc/9312029](http://xxx.lanl.gov/abs/gr-qc/9312029).
...
"[week3](week3.html)"), who was using the extended loop representation
