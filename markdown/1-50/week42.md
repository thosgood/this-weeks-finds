...
loops, knots and gauge fields (see [week18](week18.html)), I gave
references to some early papers on the subject:

1) QCD and the string model, by Y. Nambu, Phys. Lett. B80 (1979)
372-376.

Gauge fields as rings of glue, A. Polyakov, Nucl. Phys. B164 (1979)
171-188.

The quantum dual string wave functional in Yang-Mills theories, by J.
Gervais and A. Neveu, Phys. Lett. B80 (1979), 255-258.
...
3) Introduction to Superstrings, by Michio Kaku, New York,
...
4) Quantum background independence of closed string field theory, by
Ashoke Sen and Barton Zwiebach, 60 pages, phyzzx.tex, MIT-CTP-2244,
available as [hep-th/9311009](http://xxx.lanl.gov/abs/hep-th/9311009).

Background independent algebraic structures in closed string field
theory, by Ashoke Sen and Barton Zwiebach, phyzzx.tex, MIT-CTP-2346,
available as [hep-th/9408053](http://xxx.lanl.gov/abs/hep-th/9408053).
...
input tubes and one output. In short, there is an operation from X(n1) x
... x X(nk) x X(k) to X(n1 + ... + nk). For example, if we take the
...
10) A reformulation of the Ponzano-Regge quantum gravity model in terms
...
[week16](week16.html) and [week38](week38.html). It's an approach to
...
TAUP-2204-94, 12 pages in LaTeX format available as
[hep-th/9410004](http://xxx.lanl.gov/abs/hep-th/9410004).
...
April 1993, Trieste, Italy), available as
[hep-th/9308158](http://xxx.lanl.gov/abs/hep-th/9308158).
...
12) Chern-Simons-Witten theory as a topological Fermi liquid, by
Michael R. Douglas, Rutgers University preprint RU-94-29, available as
[hep-th/9403119](http://xxx.lanl.gov/abs/hep-th/9403119).
