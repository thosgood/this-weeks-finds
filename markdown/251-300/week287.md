...
with the set where all the coordinates x~i~ are nonnegative.
...
see items E and F of \"[week116](week116.html)\".)
...
free module with one generator dx~i~ for each independent coordinate. So
...
above improved version of \"[week287](week287.html)\". To see the
