...
Here we are feeding the outputs of n operations g_1,..,g~n~ into the
...
o (g_1, ..., g~n~) where f is in J and at least one of the g_i's in
...
|Lie|(x) = \sum~n~ dim(Lie~n~) x^n/n!

|Assoc|(x) = \sum~n~ dim(Assoc~n~) x^n/n!

                = \sum~n~ x^n

                = 1/(1-x)

|Comm|(x) = \sum~n~ dim(Comm~n~) x^n/n!
...
Comm(Lie(V)) ≅ &oplus~n~ Poisson~n~ \otimes V^\otimesn^
