...
0. This trefoil shrinks as c → 0, and at c = 0 it reduces to a single
...
\"[week62](week62.html)\" for those.)

Yes, we\'ve secretly been studying the Coxeter diagram A~2~, whose
...
together with the point (∞, ∞), which we include to make things nicer.

Clearly this elliptic curve has two points (x,y) for each value of x
*except* for x = ∞ and the roots of P(x), where it just has one. So,
...
a lot more explanation, read \"[week229](week229.html)\".

Now, way back in \"[week13](week13.html)\", I turned this story around.
...
So, we can think of g~2~ and g~3~ as coordinates on our 2d space of
depressed cubics! They\'re just rescaled versions of our coordinate
functions B and C.

What\'s the big deal? Well, g~2~ and g~3~ are famous examples of
\"modular forms\" - whatever those are. In fact, it\'s a famous fact
that every modular form is a polynomial in g~2~ and g~3~.

I defined modular forms back in \"[week142](week142.html)\", where I
...
\"[week233](week233.html)\". And, it was Chris Hillman who first told
