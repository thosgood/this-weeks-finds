...
the rational numbers gives a new abelian group Q \otimes G that includes
elements like

q \otimes g

where g ∈ G and q is a rational number. Any element g of G gives an
element of Q \otimes G, namely
...
So, torsion elements of G get sent to zero in Q \otimes G. We've killed the
torsion.

But the great thing about this trick is that Q \otimes G is even better than a
