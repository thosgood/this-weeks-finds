...
\"fundamental group\" of X and denoted π~1~(X), consists of equivalence
...
The fundamental group of the circle is Z, the group of integers. The
...
But suppose you had a space whose fundamental group was Q, the rational
...
circle\", whose fundamental group is indeed Q. Then you can see how it
actually works.
...
homotopy groups tensored with Q. This process turns their homotopy
...
generated abelian group always looks like Z^n^ × T where T is finite.
...
the rational numbers gives a new abelian group Q ⊗ G that includes
elements like

q ⊗ g

where g ∈ G and q is a rational number. Any element g of G gives an
element of Q ⊗ G, namely
...
So, torsion elements of G get sent to zero in Q ⊗ G. We\'ve killed the
torsion.

But the great thing about this trick is that Q ⊗ G is even better than a
...
you\'ve built has Q as its fundamental group, because for any loop g and
...
::: {align="center"}
![](rational_circle_kenneth_baker_1a.jpg)
:::
...
::: {align="center"}
![](rational_circle_kenneth_baker_1b.jpg)
:::
...
::: {align="center"}
![](rational_circle_kenneth_baker_1c.jpg)
:::
...
::: {align="center"}
![](rational_circle_kenneth_baker_2a.jpg)
:::
...
::: {align="center"}
![](rational_circle_kenneth_baker_2b.jpg)
:::
...
>
> > for all a ∈ A and all positive integers n, there exists a unique b ∈
> > A such that nb=a.
>
> And this condition clearly determines what the scalar multiplication
> over Q must be. (In fact, it\'s an \'iff\': an abelian group admits
