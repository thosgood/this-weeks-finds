...
But this operator is not linear, because doubling ψ would quadruple ψ ⊗
ψ.
...
If you pick an orthonormal basis for H, say e~i~, there\'s a unique
...
back in \"[week268](week268.html)\". There are the \"associative law\"
...
\"[week268](week268.html)\" I explained that a commutative Frobenius
...
bases e~i~ and f~j~ such that

\|\<e~i~,f~j~\>\|

is independent of i and j. This means that if you know precisely which
state e~i~ your system is in, it has equal chances of being found in any
of the states f~j~.
...
I told you about our last get-together in \"[week265](week265.html)\".
