...
anything really exciting happens\... just like in the [old
joke](http://en.wikipedia.org/wiki/Spherical_cow) where the punchline is
...
[Victor
Weisskopf](http://globetrotter.berkeley.edu/conversations/Weisskopf/)
...
> Acos(ωt). If the point is unstable, the motion will be described by
> hyperbolic functions of time, sinh(ωt) instead of sin(ωt). An ordinary
...
::: {align="center"}
![](http://www.physics.miami.edu/~nearing/mathmethods/power-sine-series.gif){width="350"}
:::
...
says that a map from X × Y to Z should correspond to a map from X to
C(Y,Z). A category with this property is called \"cartesian closed\".
...
Freudenthal and Tits, which I discussed in \"[week145](week145.html)\"
and my [octonion
webpages](http://math.ucr.edu/home/baez/octonions/node16.html).
...
It then turns out that the exceptional Lie algebras F~4~, E~6~, E~7~ and
...
>
> [Friedhelm Waldhausen\'s
> lectures](http://www.math.uni-bielefeld.de/~fw/) on algebraic topology
> and K-theory.
>
> [DML: Digital Mathematics
> Library](http://www.mathematik.uni-bielefeld.de/~rehmann/DML/dml_links_author_A.html)
>
...
> F~4~ \...\" but he goes on to say \"\... sp(6,K) \... when K = O it is
...
because every other possesses the whole of it.* - Thomas Jefferson
