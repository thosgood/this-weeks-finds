...
\"[week160](week160.html)\", and showed you the first pictures of its
lakes in \"[week210](week210.html)\".)
...
n-dimensional holes the space has - see \"[week102](week102.html)\" for
details.
...
Mathieu groups (see \"[week234](week234.html)\") on up to the Monster
(see \"[week20](week20.html)\" and \"[week66](week66.html)\").
...
E~8~ defined over F~3~, the field with 3 elements. It has about 9 ×
10^16^ elements, and it has a 248-dimensional representation over F~3~.
...
groups in \"[week145](week145.html)\" and
\"[week253](week253.html)\"\... but he\'s more famous for his work on
...
\"[week62](week62.html)\". But let\'s do an easy one: the symmetry group
of an equilateral triangle.

I can\'t resist mentioning that this group is also S~3~, the group of
all permutations of the three vertices of the triangle. In fact, this
group was the star of \"[week261](week261.html)\", where it showed up as
...
S~3~ modulo the even permutations, namely Z/2. Galois theory says you
...
This gives a presesentation of our group S~3~. We can summarize this
...
carefully back in \"[week62](week62.html)\". If you know about Dynkin
diagrams, these are pretty similar - see \"[week63](week63.html)\" and
\"[week64](week64.html)\" for details.
...
chop the plane into 6 \"chambers\", and the group S~3~ has 6 elements.
...
\"Yang-Baxter equation\" mentioned in \"[week261](week261.html)\".)
...
symmetry group of the regular tetrahedron, also known as S~4~, the group
...
Draw all mirrors corresponding to reflections in S~4~, and show they
chop 3d space into 24 chambers, one for each element of S~4~. Then,
...
and remove some of the labels, I get the so-called A~2~ Dynkin diagram:
...
those back in \"[week258](week258.html)\". I guess the main difference
