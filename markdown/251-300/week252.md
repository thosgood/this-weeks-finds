...
::: {align="center"}
[![](neptune.jpg){width="300"}](http://en.wikipedia.org/wiki/Neptune)
:::
...
core will be left. In \"[week223](week223.html)\" I quoted Bruce
...
::: {align="center"}
[![](uranus.jpg)](http://en.wikipedia.org/wiki/Uranus)
:::
...
::: {align="center"}
[![](neptune_great_dark_spot.jpg)](http://en.wikipedia.org/wiki/Great_Dark_Spot)
:::
...
Report at <http://planetquest.jpl.nasa.gov/documents/RdMp272.pdf>
...
world\'s best SF libraries: the [Eaton
Collection](http://eaton-collection.ucr.edu/). Since my wife is involved
...
> filaments, driven by the E = v × B of conducting molecular clouds
...
Back in \"[week248](week248.html)\", I mentioned some of the complex
...
filaments, and a fairly strong magnetic field that contains about 4 ×
10^47^ joules of energy within about 300 light years of the galactic
...
\"[week250](week250.html)\" we reached the point of seeing how spans of
...
::: {align="center"}
[![](burnside.jpg)](http://www-groups.dcs.st-and.ac.uk/~history/Biographies/Burnside.html)
:::
...
::: {align="center"}
[![](frobenius.jpg)](http://www-groups.dcs.st-and.ac.uk/~history/Biographies/Frobenius.html)
:::
...
\"[week249](week249.html)\". I wasn\'t paying enough attention. But how
...
are lots of *different ways* to slice the direct sum V + V into two
...
*one way* to chop the disjoint union S + S into two copies of the G-set
S. I just look at the two orbits.\"

Georg says, \"Hmm. This is actually a rather delicate point. There\'s
...
[every group with an odd number of elements is
solvable](http://en.wikipedia.org/wiki/Odd_order_theorem) without using
the tools of linear algebra.\"

William nods. \"I admit that linear algebra is very practical. But just
give us time! I proved back in 1904 that every group of size p^a^q^b^ is
...
algebra, nobody can even prove my famous theorem on \'[Frobenius
groups](http://en.wikipedia.org/wiki/Frobenius_group)\'. The details
...
G acting on a set S. Then I can form the vector space C\[S\] whose
...
sloppy we can think of guys in C\[S\] as functions on S that vanish
...
transitively on S, its representation on C\[S\] is hardly ever
irreducible.\"
...
Georg. \"In fact, we can break C\[S\] into precisely two irreps whenever
...
map from X to Y gives an intertwining operator from C\[X\] to C\[Y\].
...
special cases, like in study of modular forms, they\'re called \"[Hecke
operators](http://en.wikipedia.org/wiki/Hecke_operator)\". In some other
famous special cases, like in the study of symmetric groups, they form
algebras called \"[Hecke
algebras](http://en.wikipedia.org/wiki/Hecke_algebra)\".
...
we\'re going. Recall from \"[week250](week250.html)\" that invariant
...
back in \"[week248](week248.html)\" that spans of groupoids give linear
...
more it is studied* - William Burnside
