...
So, while in \"[week286](week286.html)\" I defined rational spaces to be
...
homotopies. Folks call this sort of gadget an \"E~∞~-algebra\".
...
N(X) ⊗ N(Y). Alas, Alexander-Whitney followed by Eilenberg-Zilber is not
the identity on N(X ⊗ Y). But, it\'s chain homotopic to the identity!
