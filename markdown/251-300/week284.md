...
uses it. Check out the
[nLab entry](http://www.ncatlab.org/nlab/show/pentagon+decagon+hexagon+identity)
...
the special session with a talk on
"[Categorifying quantum groups](https://math.ucr.edu/home/baez/ams_2009/Lauda_AMS_UCR_2009.mov)". Luckily he'd come from
...
interested in Crane and Frenkel's dream of categorified [quantum groups](http://en.wikipedia.org/wiki/Quantum_group). Now this dream is
...
4) Mikhail Khovanov and Aaron Lauda, "A diagrammatic approach to categorification of quantum groups I-III", available as [`arXiv:0803.4121`](http://arxiv.org/abs/0803.4121), [`arXiv:0804.2080`](http://arxiv.org/abs/0804.2080), and [`arXiv:0803.3250`](http://arxiv.org/abs/0807.3250).
...
answer is simple: just take its [Grothendieck group](http://ncatlab.org/nlab/show/Grothendieck+group)! A bit more
precisely: we take the category of [finitely generated](http://en.wikipedia.org/wiki/Finitely_generated_module)
...
5) Aaron Lauda, "A categorification of quantum $\mathfrak{sl}(2)$", available as [`arXiv:0803.3652`](http://arxiv.org/abs/0803.3652).

6) Aaron Lauda, "Categorified quantum $\mathfrak{sl}(2)$ and equivariant cohomology of iterated flag varieties", available as [`arXiv:0803.3848`](http://arxiv.org/abs/0803.3848).
...
Right after Aaron, he gave a talk on "[Categorification via quiver varieties](https://math.ucr.edu/home/baez/ams_2009/Licata_AMS_UCR_2009.mov)", based on these papers:

6) Sabin Cautis, Joel Kamnitzer, and Anthony Licata, "Coherent sheaves and categorical $\mathfrak{sl}(2)$ actions", available as
[`arXiv:0902.1796`](http://arxiv.org/abs/0902.1796).

7) Sabin Cautis, Joel Kamnitzer, and Anthony Licata, "Derived equivalences for cotangent bundles of Grassmannians via categorical $\mathfrak{sl}(2)$ actions", available as [`arXiv:0902.1797`](http://arxiv.org/abs/0902.1797).
...
8) Neil Chriss and Victor Ginzburg, _Representation Theory and Complex Geometry_, Birkhauser, Boston, 1997.
...
build vector spaces starting from $\mathbb{C}^2$. Why? Because the group $\mathrm{SL}(2)$
acts as symmetries of $\mathbb{C}^2$, and thus on any vector space functorially
...
Here's the example Licata explained. The group $\mathrm{SL}(2)$ acts on $\mathbb{C}^2$ and
...
$k$-dimensional subspaces of $\mathbb{C}^n$. This is called the "Grassmannian"
...
$T^*\mathrm{Gr}(k,n)$ by a category called the "bounded [derived category](http://en.wikipedia.org/wiki/Derived_category) of [coherent sheaves](http://en.wikipedia.org/wiki/Coherent_sheaf)" on this space.
...
First Alex Hoffnung spoke about "[A categorification of the Hecke algebra](https://math.ucr.edu/home/baez/ams_2009/Hoffnung_AMS_UCR_2009.mov)". The idea here is to
see the [Hecke algebras](http://en.wikipedia.org/wiki/Hecke_algebra)
associated to [Dynkin diagrams](http://en.wikipedia.org/wiki/Coxeter%E2%80%93Dynkin_diagram)
as a special case of a much more general construction: the Hecke
bicategory.

Given a finite group $G$, the Hecke bicategory $\mathsf{Hecke}(G)$ is a gadget
where:

- objects are finite $G$-sets;
- the groupoid of morphisms from $X$ to $Y$ is the weak quotient $(X \times Y)//G$.
...
we can squash $\mathsf{Hecke}(G)$ down into a category that has a mere vector
...
Then Christopher Walker gave a talk on "[A categorification of Hall algebras](https://math.ucr.edu/home/baez/ams_2009/CWalker_AMS_UCR_2009.mov)". Unfortunately, the
...
10) John Baez, Alex Hoffnung and Christopher Walker, "Higher-dimensional algebra VII: groupoidification". [`arXiv:0908.4305`](http://arxiv.org/abs/0908.4305).

Next came three talks on homotopy theory.

Jonathan Lee of Stanford University spoke on "[Homotopy colimits and the space of square-zero upper-triangular matrices](https://math.ucr.edu/home/baez/ams_2009/Lee_AMS_UCR_2009.mov)". You can see slides of his
talk here:
...
equipped with a decomposition into cells. These are the "[Schubert cells](http://en.wikipedia.org/wiki/Schubert_variety)". They're
...
talk on "[Real Johnson-Wilson theories](https://math.ucr.edu/home/baez/ams_2009/Averett_AMS_UCR_2009.mov)", based on work with
...
ideas which include [elliptic cohomology](http://www.math.harvard.edu/~lurie/papers/survey.pdf) and
...
the group $\mathbb{Z}/2$ acts on the complex K-theory spectrum $KU$, and if we take
...
for [complex cobordism theory](http://en.wikipedia.org/wiki/Complex_cobordism) is called $MU$.
If you localize this at 2 you get something called the [Brown-Peterson spectrum](http://en.wikipedia.org/wiki/Complex_cobordism#Brown-Peterson_cohomology),
...
off all the generators above the $n$th, you get the $n$th Johnson-Wilson
...
Emin Tatar of Florida State University spoke on "[Abelian sheaves and Picard stacks](https://math.ucr.edu/home/baez/ams_2009/Tatar_AMS_UCR_2009.mov)":
...
14) A. Emin Tatar, "Length 3 complexes of abelian sheaves and Picard $2$-stacks", available as [`arXiv:0906.2393`](http://arxiv.org/abs/0906.2393).
...
For more discussion visit the [$n$-Category Café](http://golem.ph.utexas.edu/category/2009/11/this_weeks_finds_in_mathematic_45.html).
