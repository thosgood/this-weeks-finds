...
::: {align="center"}
[![](betelgeuse.jpg){width="250"}](http://en.wikipedia.org/wiki/Betelgeuse)
:::
...
likely to become a [type II
supernova](http://en.wikipedia.org/wiki/Type_II_supernova). Such
...
10^9^ / (4 × 10^7^)^2^ ≅ 7 × 10^-7^

as bright as the Sun, and ten times that bright.

As I mentioned, the full Moon is about 2 × 10^-6^ times as bright as the
...
in \"[week144](week144.html)\" I reported a bunch of evidence for a
...
::: {align="center"}
[![](local_interstellar_cloud.jpg)](http://antwrp.gsfc.nasa.gov/apod/ap000411.html)
Map of the local interstellar medium within 10 years of the Sun,\
...
In \"[week200](week200.html)\" I talked about Lawvere\'s work on
...
explained how you get this back in \"[week200](week200.html)\". If we
have a functor
...
in the world of sets! We could replace Set by any other category with
...
For example, if C is the theory of groups and X is Set, a model of C in
X is a group. If instead X is the category of topological spaces, a
model of C in X is a topological group. And so on. In general people
call a model of this particular theory C in any old X a \"group object
in X\".

But as you might fear, we want to understand more than a single model of
C in X. As category theorists, we want to understand the whole
...
topological spaces, Mod(C,X) is the category of topological groups and
...
generally back in \"[week89](week89.html)\", and said how to get them
from adjoint functors in \"[week92](week92.html)\"; in
\"[week257](week257.html)\" I gave some links to some great videos by
...
In fact it does whenever X has colimits that distribute over the finite
products! For example, it does when X = Set. And Mélliès and Tabareau
...
Mod(C,X), which sits inside Hom(C,X). This gives us a functor
...
\"TLE\" refers to the \"[two-line
element](http://www.mindspring.com/~n2wwd/html/body_tle_format.html)\"
