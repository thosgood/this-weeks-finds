...
\"[week66](week66.html)\" for a quick intro to Monstrous Moonshine.)
...
theory, see \"[week124](week124.html)\", \"[week125](week125.html)\" and
...
\"[week125](week125.html)\"). But, its bizarre coefficients turn out to
...
about Hecke operators, he shows that as k → ∞, the agreement becomes
perfect!
...
As mentioned back in \"[week66](week66.html)\", Edward Witten once
...
increasing size, they\'re called g~2~, f~4~, e~6~, e~7~ and e~8~.

In 1914, Cartan realized that the smallest exceptional Lie algebra g~2~,
...
we give E(5\|10) a clever grading where x~1~, x~2~, x~3~ are treated
...
Standard Model, namely S(U(3) × U(2)). In particular, the even part of
