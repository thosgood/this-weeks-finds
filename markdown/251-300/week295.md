...
\"[week293](week293.html)\" and \"[week294](week294.html)\" - so if
...
individual resistors, say V~1~ and V~2~:
...
individual resistors, say I~1~ and I~2~:
...
for electrical circuits, as mentioned in \"[week291](week291.html)\".
...
\"[week293](week293.html)\" and \"[week294](week294.html)\". First, for
any edge
...
We need to find φ~1~ that minimizes the total power

P = (φ~1~ - φ~0~)^2^/R~1~ + (φ~2~ - φ~1~)^2^/R~2~

So, we differentiate P with respect to φ~1~ and set the derivative to
zero:

2(φ~1~ - φ~0~)/R~1~ - 2(φ~2~ - φ~1~)/R~2~ = 0

This implies that

V~1~ / R~1~ = V~2~ / R~2~

where V~1~ and V~2~ are the voltages across our two resistors.

By Ohm\'s law, voltage divided by resistance is current. So, we get

I~1~ = I~2~

where I~1~ and I~2~ are the currents through our two resistors. Hey -
...
Since the currents I~1~ and I~2~ are equal, let\'s call them both I.
...
talked about these faces back in \"[week293](week293.html)\": electrical
...
outlined in \"[week293](week293.html)\". Let me just sketch how that
