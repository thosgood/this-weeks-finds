...
moon of Jupiter that I introduced back in \"[week266](week266.html)\":
...
I told you about Frobenius algebras in \"[week174](week174.html)\" and
\"[week224](week224.html)\", but I think it\'s time to talk about them
...
Let\'s see some examples! For starters, we could take the algebra of n ×
...
obvious if you know what this jargon means, at least. A ⊗ A also becomes
...
isomorphism between X ⊗ Y and Y ⊗ X for any objects X and Y, which lets
...
explained way back in \"[week16](week16.html)\" and also in my seminar
...
algebra by taking the algebra of n × n matrices and defining
...
\"[week247](week247.html)\", you\'ll know about spans and how to compose
...
is equivalent to the *groupoid* of finite sets. We get FinSet^op^ if we
take algebra homomorphisms, and I guess we get FinSet if we take
