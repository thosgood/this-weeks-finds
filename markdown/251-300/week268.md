...
Now we can apply "$\mathrm{op}$" and get another functor I'll also call "not":
...
28) Michael Barr, _$*$-Autonomous Categories_, Lecture Notes in Mathematics **752**, Springer, Berlin, 1979.
