...
(\infty,1)-categories, which are \infty-categories where all the $n$-morphisms for n
...
sin(θ_1)/sin(θ_2) = n_2/n_1

where n_i is the index of refraction in the ith material and θ_i is
...
linear maps δ: C_i \to C~i-1~, obeying the equation δ^2 = 0. We also get
a cochain complex:

           d           d
    C0 --------> C1 ---------> C2

meaning a bunch of vector spaces C_i and linear maps d: C_i \to C~i+1~,
