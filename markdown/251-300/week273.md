...
In fact, any L^2 function f: R \to C can be expressed this way for some
L^2 function g: R \to C. And if we normalize things right, the Fourier
...
> functions on GL_2(R) which are invariant under GL_2(Z) (and now
