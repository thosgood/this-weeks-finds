...
For example, this is the Julia set for c = -0.743643887037151 +
0.131825904205330 i:

::: {align="center"}
![](julia_-0.743643887037151+0.131825904205330i.jpg)
:::

while this:

::: {align="center"}
![](mandelbrot_-0.743643887037151+0.131825904205330i.jpg)
:::
...
at various values of c. For example, here's the Julia set at c =
-0.689494949 - 0.462323232 i:

::: {align="center"}
![](julia_-0.689494949-0.462323232i.gif)
:::

and here's a tiny piece of Mandelbrot set near that point:

::: {align="center"}
![](mandelbrot_-0.689494949-0.462323232i.gif)
:::
...
flows, say q'_1 and q'_2. Similarly, it has two efforts p'_1 and
p'_2.
...
2.  2. A "gyrator". A gyrator trades effort for flow:
