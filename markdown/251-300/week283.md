...
like polycyclic aromatic hydrocarbons (see \"[week258](week258.html)\").
...
This continues the tale begun in \"[week236](week236.html)\" and
\"[week241](week241.html)\". Someday it\'ll get folded into a paper on
...
have been the first \"exceptional\" object in mathematics - roughtly
...
Alexandria](http://www-history.mcs.st-andrews.ac.uk/Biographies/Theon.html)
-
...
In 1808, [Francois
Peyrard](http://www.sabix.org/bulletin/b3/peyrard.html) made a marvelous
discovery. He found that the Vatican library had a copy of Euclid\'s
Elements that hadn\'t descended through Theon!

::: {align="center"}
[![](http://www.loc.gov/exhibits/vatican/images/math22.jpg)](http://www.loc.gov/exhibits/vatican/math.html)
:::
...
In the 1880s, the great Danish scholar [Johan
Heiberg](http://en.wikipedia.org/wiki/Johan_Ludvig_Heiberg_%28historian%29)
...
Anyway, Heath thinks that [Geminus of
Rhodes](http://www-history.mcs.st-andrews.ac.uk/Biographies/Geminus.html)
...
> pyrite (FeS~2~) crystallizes most often in cubes and almost-regular
...
::: {align="center"}
[![](pseudoicosahedron.gif)](http://www.uwgb.edu/dutchs/symmetry/isometuc.htm)
:::
...
::: {align="center"}
[![](pyrite.jpg)](http://www.minerals.net/mineral/sulfides/pyrite/pyrite.htm)
:::
...
They date from about 2000 BC and are kept in the Ashmolean Museum in
Oxford.
:::
...
::: {align="center"}
![](carved_stone_balls.jpg)    ![](carved_stone_balls_2.jpg)\
...
Theaetetus - is described. This construction is [Proposition
XIII.16](http://aleph0.clarku.edu/~djoyce/java/elements/bookXIII/propXIII16.html),
...
The coolest one is [Proposition
XIII.10](http://aleph0.clarku.edu/~djoyce/java/elements/bookXIII/propXIII10.html).
It goes like this.
...
::: {align="center"}
![](icosahedron_with_right_triangle.gif){width="400"}
:::
...
::: {align="center"}
![](icosahedron_with_right_triangles.gif){width="400"}
:::
...
>
> That\'s because S~4~ is a solvable group, and all Galois groups of
> quartics will live in S~4~ (and will usually be S~4~)\...
>
...
> field is Q(ζ~5~), which is a cyclotomic field, so has Galois group
...
> degree 2 subfield of Q(z) (z=ζ~5~) and aim towards it (because it\'s
...
Here ζ~5~ is number-theorist\'s jargon for a \"primitive 5th root of
...
> ::: {align="center"}
> ![](pentagon_hexagon_decagon.gif){width="500"}
> :::
>
> Here\'s a version of the proof Euclid gave, adapted from [the version
> JB
> cited](http://aleph0.clarku.edu/~djoyce/java/elements/bookXIII/propXIII10.html).
...
> FN = BN. Thus BF ^2^ = AB · BN
>
> Triangle BAK is similar to triangle KAN. So BA/AK = KA/AN. Thus AK^2^
> = AB · AN.
>
> Adding our two results, we have: BF^2^ + AK^2^ = AB · (AN + BN) =
> AB^2^.
>
> BF is our radius, AK is a decagon side, and AB is a pentagon side.
> Well done Euclid.

On Thanksgiving of 2009, I got ahold of Eva Sachs\' 1917 book *Die Fünf
Platonischen Körper*, mentioned above. It\'s supposed to be the
...
::: {align="center"}
![](http://math.ucr.edu/home/baez/icosahedron_sachs_1.jpg){width="500"}
:::

::: {align="center"}
![](http://math.ucr.edu/home/baez/icosahedron_sachs_2.jpg){width="500"}
:::
...
::: {align="center"}
![](http://math.ucr.edu/home/baez/icosahedron_with_right_triangles.gif){width="300"}
:::
