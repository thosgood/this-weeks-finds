...
them at \"[week228](week228.html)\". The frost is carbon dioxide,
...
- see \"[week235](week235.html)\" - but it\'s smaller, and still getting
...
\"[week79](week79.html)\") and polycyclic aromatic hydrocarbons (see
\"[week258](week258.html)\").
...
diamond rain on Neptune back in \"[week160](week160.html)\". And in
\"[week193](week193.html)\", I explained how diamonds are the closest
...
vector (1/2,\...,1/2). D~8~^+^ is the E~8~ lattice, but D~3~ is the
face-centered cubic, and D~3~^+^ is the pattern formed by carbons in a
diamond!
...
a lattice, the D~3~ lattice - and this is secretly the same as the A~3~
lattice, familiar from stacking oranges. It\'s one of the densest ways
to pack spheres, with a density of

π /(3√2)   ≈   0.74

The D~3~^+^ pattern, on the other hand, has a density of just

(π√3)/16   ≈   0.34

This is why ice becomes denser when it melts: it\'s packed in a close
relative of the D~3~^+^ pattern, with an equally low density.
...
\"[week253](week253.html)\" for more. Unfortunately this part of the
...
exceptional Lie algebras F~4~ and E~8~, available as
...
spinor field ψ such that

D~v~ψ = k vψ

for some constant k for every vector field v. Here D~v~ψ is the
covariant derivative of ψ in the v direction, while vψ is defined using
...
This gives the exceptional Lie algebra f~4~!
...
interpretation for some previously known algebraic constructions of f~4~
...
Does this give a nice relation between so(9), f~4~ and e~8~? Can someone
...
> so-called Freund-Rubin backgrounds: product geometries L × R, with L a
...
> K~0~ ⊕ K~1~ denote the Killing superalgebra, then
>
> K~1~ = {Killing spinors}
>
> and
...
> that starts from SO(8)×SO(8). But, considering the maximally split
> real form E8(8), did you also know that this SO(8)×SO(8) is best
...
> SO(8,C0).
>
> Basically, the way this works is that you can extend SO(8)×SO(8) to
> SO(16) or SO(8,8) - depending on whether you add the V×V or S×S
> 8×8-block. But if you take diagonal SO(8) subgroups, then the 8×8 all
