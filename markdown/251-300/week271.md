...
the A~3~ lattice, which shows up when you stack oranges:
...
of the tetrahedron is also called the A~3~ Coxeter group. It\'s the
...
This pattern goes on for higher n. Last week I spoke about the A~4~
...
plane with approximate 5-fold symmetry by taking a 2d slice of the A~4~
...
sits inside the A~4~ Coxeter group:
...
and so on: the noncrystallographic Coxeter groups I~2~(n) sit nicely
...
-   H~3~, the symmetry group of the dodecahedron, with 120 elements;
-   H~4~, the symmetry group of the 120-cell, with 120 × 120 elements.
...
\"[week20](week20.html)\" I explained the \"icosians\" - a subring of
...
of this tale, in \"[week256](week256.html)\" I described a functor from
the category with
...
as an m × n matrix of finite-dimensional vector spaces, just as we can
...
an earlier paper, which I discussed in \"[week242](week242.html)\". He
