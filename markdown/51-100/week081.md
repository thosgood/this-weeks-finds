...
[astro-ph/9412053](http://xxx.lanl.gov/abs/astro-ph/9412053).

R.J. Protheroe and P.A. Johnson, Are topological defects responsible for
...
multiplication. This is the group of phases. We can think of H\~ as H x
U(1) given a sneaky product designed to soak up the phases produced by
the cocycle:
...
X define the same element of π_k(X) if one can be continously deformed
to the other.

Saying that G is connected means that π_0(G) = 0. To understand this you
need to realize that S\^0 consists of two points. So π_0(G) = 0 means
...
H\^0(Maps(S\^3,G)) which is just another way of saying π_3(G)
