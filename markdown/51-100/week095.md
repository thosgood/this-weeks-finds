...
gauge field theories with gauge group \mathrm{E}_8 x \mathrm{E}_8 and \mathrm{SO}(32), respectively!
People seem especially optimistic that the \mathrm{E}_8 x \mathrm{E}_8 theory is relevant to
...
were classified by Niemeier. A few of these are obvious, like \mathrm{E}_8\oplus\mathrm{E}_8 +
\mathrm{E}_8 and \mathrm{E}_8 + \mathrm{D}_{16}^+, but the coolest one is the "Leech lattice", which is
