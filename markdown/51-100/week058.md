...
1\) John Barrett, Quantum gravity as topological quantum field theory,
to appear in the November 1995 special issue of Jour. Math. Physics,
also available as
[gr-qc/9506070](http://xxx.lanl.gov/abs/gr-qc/9506070).
...
talk (see also his papers listed in \"[week2](week2.html)\",
\"[week23](week23.html)\" and \"[week56](week56.html)\"), in a
...
and w in a Hilbert space you can take the inner product \<v,w\> and get
a number; similarly, given two (finite-dimensional) Hilbert spaces V and
W you can form hom(V,W) - that is, the set of all linear maps from V to
...
of finite-dimensional Hilbert spaces, but also Reps(G), the category of
...
\"hom\" behaves nicely under direct sums in each argument, but each
...
Z(M\') in Z(S), so one can form the \"inner product\" hom(Z(M),Z(M\')),
...
things around and form the inner product hom(Z(M\'),Z(M)), which is the
...
\"[week57](week57.html)\". The basic idea, there as here, is that we are
...
2\) M. Kapranov and V. Voevodsky, 2-Categories and Zamolodchikov
tetrahedra equations, in Proc. Symp. Pure Math. 56, Part 2 (1994), AMS,
Providence, pp. 177-260.

(see also \"[week4](week4.html)\") Dan Freed\'s work on higher algebraic
structures in gauge theory (\"[week12](week12.html),\"
\"[week48](week48.html)\"), and David Yetter\'s new paper:
...
as <http://math.ucr.edu/home/baez/yetter.pdf> and
...
\"[week9](week9.html)\",\"[week10](week10.html)\") used to construct a
4-dimensional TQFT. This TQFT was later shown by Roberts (see
\"[week14](week14.html)\") to be isomorphic to that described by Crane
...
Broda reference in \"[week17](week17.html)\", but I managed luckily to
get a copy of her thesis:

4\) Eugenia Cesar de Sa, Automorphisms of 3-manifolds and
...
theory with cosmological term. BF theory (see \"[week36](week36.html)\")
...
\"[week56](week56.html)\", it\'s this Chern-Simons state that plays a
...
5\) John Baez, 4-dimensional BF theory with cosmological term as a
topological quantum field theory, available as
[q-alg/9507006](http://xxx.lanl.gov/abs/q-alg/9507006).
...
<http://www.bangor.ac.uk/~mas013/preprint.html>
...
In a previous paper (see \"[week54](week54.html)\") Porter studied the
...
7\) David Yetter, TQFTs from homotopy 2-types, Journal of Knot Theory
